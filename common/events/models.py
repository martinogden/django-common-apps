...
class CommonPerformer(models.Model):
    ...
    # Decorator makes sure get_absolute_url returns a string rather
...
class CommonEvent(models.Model):
    ...
    images = generic.GenericRelation(Image)
    isgd = models.URLField(verify_exists=False, max_length=255, null=True,\
    ...
    # Decorator makes sure get_absolute_url returns a string rather than
    # the full object!
    @models.permalink
    def get_permalink(self):
        return ('event_detail', (), {
